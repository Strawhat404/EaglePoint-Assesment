...
The searched url links and more detailed documentation is shared on Google Docs: https://docs.google.com/document/d/1DVtA7zH2mRna-WS9-puwgg2A2nd_xat4xOJ-HdlsMR4/edit?usp=sharing

## Project Structure

### 1. Smart Text Analyzer (Python)
*   **File:** `task1.py`
*   **Description:** A text processing tool that cleans later changed to manual text cleaning to enhance readablity , calculates word statistics (average length, longest words), and generates frequency maps using `collections.Counter`.
